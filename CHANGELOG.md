...
- Remove `scriptComposer` api due to increase in the sdk bundle size, If you wish to continue using it, please use version 1.39.0: [https://www.npmjs.com/package/@libra2org/ts-sdk/v/1.39.0](https://www.npmjs.com/package/@libra2org/ts-sdk/v/1.39.0)
